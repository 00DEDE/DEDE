...
var SEQUENCE = [
  ...
  { zone: 1,  world: 'monuments',  location: 'Joya de Cer\u00e9n',       region: 'La Libertad, El Salvador',   desc: 'A pre-Columbian Maya farming village buried by volcanic ash around 600 CE, offering an extraordinary snapshot of daily life in Mesoamerica.',                  page: 30, left: 23, top: 39 },
  ...
  { zone: 5,  world: 'monuments',  location: 'Nan Madol',                region: 'Pohnpei, Micronesia',        desc: 'A ceremonial center built on artificial islands of basalt and coral, sometimes called the \u201cVenice of the Pacific.\u201d',                                 page: 38, left: 88, top: 41 },
  { zone: 6,  world: 'monuments',  location: 'Machu Picchu',             region: 'Cusco Region, Peru',         desc: 'A 15th-century Inca citadel set high in the Andes Mountains, renowned for its sophisticated dry-stone construction and panoramic terraces.',                    page: 40, left: 27, top: 50 },

  // Nature (Green) — pages 46, 48, 50, 52, 54 + Great Barrier Reef
  { zone: 7,  world: 'nature',     location: 'Serengeti National Park',  region: 'Northern Tanzania',          desc: 'A vast ecosystem famous for the annual migration of over 1.5 million wildebeest and hundreds of thousands of zebra.',                                        page: 46, left: 54, top: 46 },
  { zone: 8,  world: 'nature',     location: 'Socotra Archipelago',      region: 'Arabian Sea, Yemen',         desc: 'An isolated archipelago with one of the most distinct floras on Earth, including the iconic dragon blood tree.',                                              page: 48, left: 60, top: 38 },
  { zone: 9,  world: 'nature',     location: 'Wulingyuan Scenic Area',   region: 'Hunan Province, China',      desc: 'Over 3,000 quartzite sandstone pillars and peaks rising above subtropical forest, shaped by millions of years of erosion.',                                   page: 50, left: 73, top: 29 },
  { zone: 10, world: 'nature',     location: 'Lake Turkana',             region: 'Northern Kenya',             desc: 'The world\u2019s largest desert lake and a critical site for the study of human evolution, with major fossil discoveries.',                                   page: 52, left: 56, top: 42 },
  { zone: 11, world: 'nature',     location: 'Grand Canyon',             region: 'Arizona, United States',     desc: 'A steep-sided canyon carved by the Colorado River, revealing nearly two billion years of Earth\u2019s geological history.',                                   page: 54, left: 16, top: 28 },
  { zone: 12, world: 'nature',     location: 'Great Barrier Reef',       region: 'Queensland, Australia',      desc: 'The world\u2019s largest coral reef system, spanning over 2,300 kilometres and home to extraordinary marine biodiversity.',                                    page: 56, left: 85, top: 52 },

  // Intangible Heritage (Cream) — pages 64, 66, 68, 70
  { zone: 13, world: 'intangible', location: 'Flamenco',                 region: 'Andalusia, Spain',           desc: 'A deeply expressive art form combining cante (singing), baile (dance), and toque (guitar), rooted in Andalusian culture.',                                    page: 64, left: 44, top: 28 },
  { zone: 14, world: 'intangible', location: 'Jazz',                     region: 'New Orleans, United States', desc: 'Born from African American communities, jazz is defined by improvisation, syncopated rhythms, and blues tonality.',                                          page: 66, left: 22, top: 30 },
  { zone: 15, world: 'intangible', location: 'Backstrap Loom Weaving',   region: 'Guatemalan Highlands',       desc: 'An ancient Maya textile tradition using portable looms, producing vibrant handwoven fabrics that carry cultural identity.',                                    page: 68, left: 20, top: 36 },
  { zone: 16, world: 'intangible', location: 'Tango',                    region: 'Buenos Aires, Argentina',    desc: 'A passionate dance and musical genre born in the R\u00edo de la Plata region, blending European and African influences.',                                     page: 70, left: 31, top: 60 },

  // Languages (Yellow) — pages 76, 78, 80, 82
  { zone: 17, world: 'language',   location: '\u02bbŌlelo Hawai\u02bbi', region: 'Hawaii, United States',      desc: 'The native language of Hawaii, nearly lost by the 1980s, now being revived through immersion schools and cultural programs.',                                   page: 76, left: 6, top: 34 },
  { zone: 18, world: 'language',   location: 'N\u00fcshu Script',        region: 'Hunan Province, China',      desc: 'The only known writing system created and used exclusively by women, a remarkable expression of female solidarity.',                                          page: 78, left: 77, top: 34 },
  { zone: 19, world: 'language',   location: 'Occitan',                  region: 'Southern France',            desc: 'A Romance language that was the literary language of medieval troubadours, now classified as severely endangered.',                                             page: 80, left: 47, top: 23 },
  { zone: 20, world: 'language',   location: 'Ainu',                     region: 'Hokkaido, Japan',            desc: 'A critically endangered language isolate of the indigenous Ainu people, known for its rich oral epic traditions.',                                              page: 82, left: 84, top: 24 }
];
